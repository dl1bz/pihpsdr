...
The CFC activation and it's configuration profile is only hard-coded in the src/transmitter.c at this time, no access from GUI at this time.
...
I add a lot of comments for understand. The CFC is part of the WDSP library, but up to now piHPSDR don't use it.
